    ...
    extends AbstractMojo
{
    ...
    protected WarPackagingContext createWarPackagingContext(File webappDirectory, 
            WebappStructure cache, OverlayManager overlayManager, 
            List defaultFilterWrappers, List nonFilteredFileExtensions) {
        ...
        throws MojoExecutionException
    {
        ...
        while ( it.hasNext() )
        {
            ...
            {
                packagingTasks.add(createWarPackagingTask());
            }
            else
            {
    ...
    protected WarProjectPackagingTask createWarPackagingTask() {
        return new WarProjectPackagingTask( webResources, webXml, containerConfigXML );
    }
